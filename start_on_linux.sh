...
echo "\033[0;32mFIWARE setup started.\033[0m"
# sudo chown -R 1000:1000 node-red
docker compose pull
echo "\033[0;32mDocker images updated.\033[0m"
# docker compose down -v --remove-orphans
echo "\033[0;32mDocker containers restarting...\033[0m"
docker compose -p fiware up -d --remove-orphans --build
echo "\033[0;32mDocker containers restarted.\033[0m"
echo ""
echo "\033[0;44m FIWARE Stack \033[0m"
...
echo ""
echo "\033[1;36mWelcome to FIWARE\033[0m"
